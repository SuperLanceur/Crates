...
public class ItemBuilder {
    ...
    public ItemBuilder(Material mat, DyeColor dyeColor){
        if(mat == Material.WOOL)
            stack = new Wool(dyeColor).toItemStack();
        else if(mat == Material.STAINED_CLAY)
            stack = new ItemStack(mat, 1, dyeColor.getData());
    }
